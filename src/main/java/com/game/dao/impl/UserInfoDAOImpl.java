...
public class UserInfoDAOImpl implements UserInfoDAO {
	...
	public List<Map<String, String>> selectUserInfoList(Map<String, String> userInfo) {
		String sql = "SELECT UI_NUM, UI_NAME, UI_ID, UI_PWD, UI_IMG_PATH, UI_DESC, UI_BIRTH, "
				+ "CREDAT, CRETIM, LMODAT, LMOTIM, ACTIVE FROM USER_INFO;";
	...
	public int insertUserInfo(Map<String, String> userInfo) {
		String sql = "INSERT INTO USER_INFO(\r\n"
				+ "UI_NAME, UI_ID, UI_PWD, UI_IMG_PATH, UI_DESC, UI_BIRTH, CREDAT, CRETIM, LMODAT, LMOTIM) \r\n"
