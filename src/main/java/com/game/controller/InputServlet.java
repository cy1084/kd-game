...
public class InputServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * desc = request.getParameter("desc"); String trans =
		 * request.getParameter("trans"); String job = request.getParameter("job");
		 * 
		 * String result = "이름: " + name + " 아이디: " + id + " 비밀번호: " + pwd + " 설명: " +
		 * desc + " 성별: " + trans + " 직업: "+ job;
		 */
